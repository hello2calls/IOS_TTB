...
//typedef struct fec_ratio_cfg fec_ratio_cfg;
//typedef struct fec_config fec_config;
 ...
 */
PJ_DECL(pj_status_t) pjmedia_stream_get_final_postkid( pjmedia_stream * stream, pj_sockaddr * addr, unsigned * type);

PJ_DECL(pj_status_t) pjmedia_stream_set_network_type( pjmedia_stream * stream, int network_type);
/**
 ...
 */
PJ_DECL(char) pjmedia_stream_get_last_jb_frame_type(pjmedia_stream *stream);
...
PJ_DECL(int)
pjmedia_stream_get_rtp_jbuf_total(pjmedia_stream *stream);

PJ_DECL(int)
pjmedia_stream_get_rtp_jbuf_loss(pjmedia_stream *stream);

PJ_DECL(pj_status_t)
pjmedia_stream_set_decode_grp_stat(pjmedia_stream *stream);

PJ_DECL(pj_status_t)
start_relay_encode(rtp_start_relay *data, pj_bool_t is_type_postman);

PJ_DECL(pj_status_t)
stop_relay_encode(rtp_stop_relay *data);
