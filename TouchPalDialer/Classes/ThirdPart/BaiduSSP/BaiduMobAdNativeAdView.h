...
-(id)initWithFrame:(CGRect)frame
             title:(UILabel *) titleLabel
              text:(UILabel *) textLabel
              icon:(UIImageView *) iconView
         mainImage:(UIImageView *) mainView DEPRECATED_ATTRIBUTE;
...
-(id)initWithFrame:(CGRect)frame
             title:(UILabel *) titleLabel
              ...
              icon:(UIImageView *) iconView
         mainImage:(UIImageView *) mainView
         videoView:(BaiduMobAdNativeVideoBaseView *) videoView DEPRECATED_ATTRIBUTE;
