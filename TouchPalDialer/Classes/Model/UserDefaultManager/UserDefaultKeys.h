...
#define CHECK_DOWNLOAD_BOARDIMAGEANDVER @"CHECK_DOWNLOAD_BOARDIMAGEANDVER"
...
#define UPDATE_CUSTOM_EVENT_STRATEGY  @"UPDATE_CUSTOM_EVENT_STRATEGY"
#define USAGE_CUSTOM_EVENT_PREFIX     @"CUSTOM_EVENT_"
#define USAGE_CUSTOM_EVENT_DEFAULT_ON @"CUSTOM_EVENT_DEFAULT_SWITCHER"
#define USAGE_CUSTOM_EVENT_WHITE_LIST @"CUSTOM_EVENT_WHITE_LIST"
#define USAGE_CUSTOM_EVENT_BLACK_LIST @"CUSTOM_EVENT_BLACK_LIST"

#define FEEDS_VIDEO_PLAY_IN_DATA_CONNECTION @"feeds_video_play_in_data_connection"

//bibi
#define BIBI_LOCAL_ACCOUNT_REGISTED @"BIBI_LOCAL_ACCOUNT_REGISTED"
#define BIBI_GUIDE_SHOW_INAPP @"BIBI_GUIDE_SHOW_INAPP_%@"
#define BIBI_ACCOUNT_PAIR_CHECK @"BIBI_ACCOUNT_PAIR_CHECK"
