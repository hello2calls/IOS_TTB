...
/*
 * get a delegate view for this webview.
 */
- (id) getDelegateViews;
...
*/
- (void) evaluateJavaScript: (NSString * __nonnull) javaScriptString completionHandler: (void (^ __nullable)(id __nonnull, NSError * __nonnull)) completionHandler;
