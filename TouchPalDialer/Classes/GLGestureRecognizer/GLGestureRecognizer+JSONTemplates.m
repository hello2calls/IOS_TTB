...
- (BOOL)loadTemplatesFromJsonData:(NSString *)filePath
{
...
- (void)saveTemplatesAsJsonData:(NSString *)filePath{
    NSError *error = nil;
    NSData *jsonData = [[CJSONSerializer serializer] serializeDictionary:self.templates error:&error];
