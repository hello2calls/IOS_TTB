...
- (UIView *)cell {
    ...
    if (self.dataSource &&
        ...
        view.frame =
        CGRectMake(0, self.frame.size.height, self.frame.size.width, self.frame.size.height/3);
        view.alpha = 0;
...
- (void)cycleAnimation {
    [UIView animateWithDuration:_animationDuration
                     animations:^{
                         //_currentDisplayView.backgroundColor =[UIColor redColor];
                         ...
                         //_currentDisplayView.backgroundColor =[UIColor blueColor];
                         self.currentDisplayView.center =
                         CGPointMake(self.currentDisplayView.center.x, _currentDisplayView.tp_height/2);
