...
@interface AskLikeView(){
    UILabel *_closeLabel;
}

@end

@implementation AskLikeView
...
- (instancetype)initWithFrame:(CGRect)frame andInviteShareData:(InviteShareData *)shareData{
    ...
    if (self){
        ...
        _closeLabel.backgroundColor = [TPDialerResourceManager getColorForStyle:@"tp_color_orange_600"];
        ...
        topImageView.image = [TPDialerResourceManager getImage:@"dialog_grade_header_bg@2x.png"];
        ...
        topIconView.textColor = [TPDialerResourceManager getColorForStyle:@"tp_color_orange_600"];
        ...
        secondLabel.textColor = [TPDialerResourceManager getColorForStyle:@"tp_color_orange_600"];
        ...
        [rightButton setBackgroundImage:[FunctionUtility imageWithColor:[TPDialerResourceManager getColorForStyle:@"tp_color_orange_600"] withFrame:rightButton.bounds] forState:UIControlStateNormal];
        [rightButton setBackgroundImage:[FunctionUtility imageWithColor:[TPDialerResourceManager getColorForStyle:@"tp_color_orange_700"] withFrame:rightButton.bounds] forState:UIControlStateHighlighted];
        ...
        [DialerUsageRecord recordpath:@"path_voip" kvs:Pair(@"activity", @([[NSDate date] timeIntervalSince1970])),nil];
...
- (void)onCancelButtonClick{
    ...
    [DialerUsageRecord recordpath:@"path_voip" kvs:Pair(@"close", @([[NSDate date] timeIntervalSince1970])),nil];
    [self removeFromSuperview];
}

- (void)onCloseButtonTouchDown{
    _closeLabel.backgroundColor = [TPDialerResourceManager getColorForStyle:@"tp_color_orange_700"];
}
...
- (void)onLeftButtonClick{
    ...
    [DialerUsageRecord recordpath:@"path_voip" kvs:Pair(@"dislike", @([[NSDate date] timeIntervalSince1970])),nil];
    [self removeFromSuperview];
}
...
- (void)onRightButtonClick{
    ...
    [DialerUsageRecord recordpath:@"path_voip" kvs:Pair(@"like", @([[NSDate date] timeIntervalSince1970])),nil];
    [self removeFromSuperview];
}
