...
+ (NSString*) valueWithError:(NSError **)error {
    ...
    NSString * guuid =[UserDefaultsManager stringForKey:kAppGUUID];
    if(guuid == nil)
    {
    ...
    //
    id localDict = [UserDefaultsManager objectForKey:kOpenUDIDKey];
    ...
    if (localDict && saveLocalDictToDefaults)
        [UserDefaultsManager setObject:localDict forKey:kOpenUDIDKey];
