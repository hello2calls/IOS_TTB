...
//File Name
#define PRESENT_FILE_NAME               @"presentation_ios.xml"
#define PRESENT_FILE_TMP_NAME           @"presentation_ios.tmp"
...
//Root
#define DOCUMENT_ROOT                   @"Rules"

//Strategy
#define STRATEGY_ROOT                   @"strategy"
...
#define UPLOADCONNECTION                @"uploadConnection"
#define UPLOADINTERVAL                  @"uploadInterval"
