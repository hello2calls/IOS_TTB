//
//  TodayWidgetSecondViewFirstAnimationView.m
//  TouchPalDialer
//
//  Created by game3108 on 15/9/2.
//
//
...
@interface TodayWidgetSecondViewFirstAnimationView(){
    UIView *_bottomView;
...
@implementation TodayWidgetSecondViewFirstAnimationView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if ( self ){
        ...
        CGFloat globalY = phoneView.frame.size.height - 132*HEIGHT_ADAPT;
        _editButton = [[UIButton alloc]initWithFrame:CGRectMake((phoneView.frame.size.width-132*HEIGHT_ADAPT)/2, globalY, 132*HEIGHT_ADAPT, 18*HEIGHT_ADAPT)];
        [_editButton setTitle:@"编辑" forState:UIControlStateNormal];
        _editButton.layer.cornerRadius = 2.0f;
        _editButton.layer.masksToBounds = YES;
        _editButton.titleLabel.font = [UIFont systemFontOfSize:10*HEIGHT_ADAPT];
        [_editButton setBackgroundImage:[FunctionUtility imageWithColor:[TPDialerResourceManager getColorForStyle:@"tp_color_white_transparency_600"] withFrame:_editButton.bounds] forState:UIControlStateNormal];
        [_editButton setBackgroundImage:[FunctionUtility imageWithColor:[TPDialerResourceManager getColorForStyle:@"tp_color_white_transparency_200"] withFrame:_editButton.bounds] forState:UIControlStateHighlighted];
        [_editButton setTitleColor:[TPDialerResourceManager getColorForStyle:@"tp_color_black_transparency_600"] forState:UIControlStateNormal];
        [_editButton setTitleColor:[TPDialerResourceManager getColorForStyle:@"tp_color_black_transparency_200"] forState:UIControlStateHighlighted];
