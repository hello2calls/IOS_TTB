//
//  TodayWidgetSecondViewSecondAnimationView_iOS10.m
//  TouchPalDialer
//
...
@interface TodayWidgetSecondViewSecondAnimationView_iOS10(){
...
@implementation TodayWidgetSecondViewSecondAnimationView_iOS10
...
- (void)addViewOnSelf:(CGRect)frame{
    ...
    phoneView.image = [TPDialerResourceManager getImage:@"today_widget_screen_bg02_ios10@2x.png"];
    [self addSubview:phoneView];
    
    CGFloat globalY = 81*HEIGHT_ADAPT;
    
    UIImage *image1 = [TPDialerResourceManager getImage:@"today_widget_cell_up01_ios10@2x.png"];
    ...
    _imageView2.image = [TPDialerResourceManager getImage:@"today_widget_cell_up02_ios10@2x.png"];
    ...
    _imageView6.image = [TPDialerResourceManager getImage:@"today_widget_cell_up03_ios10@2x.png"];
    [self addSubview:_imageView6];
    
    UIImage *image3 = [TPDialerResourceManager getImage:@"today_widget_cell_down01_ios10@2x.png"];
    ...
    UIImage *image4 = [TPDialerResourceManager getImage:@"today_widget_cell_down02_ios10@2x.png"];
    ...
    _imageView4.image = [TPDialerResourceManager getImage:@"today_widget_cell_down02_ios10@2x.png"];
    ...
    _imageView5.image = [TPDialerResourceManager getImage:@"today_widget_cell_down03_ios10@2x.png"];
...
- (void)seventhAnimation{
    ...
    _topLabel = [[UILabel alloc]initWithFrame:CGRectMake(_imageView6.frame.size.width - 34*HEIGHT_ADAPT, _imageView6.frame.origin.y + _imageView6.frame.size.height + 4*HEIGHT_ADAPT ,30*HEIGHT_ADAPT, 14*HEIGHT_ADAPT)];
    _topLabel.text = @"置顶";
...
- (void)eighthAnimation{
    ...
    UIImage *image = [TPDialerResourceManager getImage:@"today_widget_cell_up03_ht_ios10@2x.png"];
