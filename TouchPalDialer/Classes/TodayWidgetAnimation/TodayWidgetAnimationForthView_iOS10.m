//
//  TodayWidgetAnimationForthView_iOS10.m
//  TouchPalDialer
//
...
@interface TodayWidgetAnimationForthView_iOS10(){
    UIView *centerView;
    UIView *_bottomView;
...
@implementation TodayWidgetAnimationForthView_iOS10
...
- (void)addViewOnSelf:(CGRect)frame{
    ...
    //
    UIImage *cellImage = [TPDialerResourceManager getImage:@"today_widget_cell_identify_ios10@2x.png"];
    CGFloat cellHeight = cellImage.size.height/cellImage.size.width*phoneView.frame.size.width;
    
    _cellView = [[UIImageView alloc]initWithFrame:CGRectMake(4, 140 * HEIGHT_ADAPT, phoneView.frame.size.width- 8, cellHeight)];
